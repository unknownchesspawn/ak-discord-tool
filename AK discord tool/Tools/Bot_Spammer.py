...
ascii_art = r"""
            ____        __     _____                                          
           / __ )____  / /_   / ___/____  ____ _____ ___  ____ ___  ___  _____
          / __  / __ \/ __/   \__ \/ __ \/ __ `/ __ `__ \/ __ `__ \/ _ \/ ___/
         / /_/ / /_/ / /_    ___/ / /_/ / /_/ / / / / / / / / / / /  __/ /    
        /_____/\____/\__/   /____/ .___/\__,_/_/ /_/ /_/_/ /_/ /_/\___/_/     
                                /_/                                          
"""
...
async def on_ready():
    ...
    try:
        ...
        if not channel:
            ...
            print(f"Sending message '{message_to_send}' {repeat_count} times...")
